...
def get_info(DD_token,DD_cookies):
    try:
        info_url = f'https://maicai.api.ddxq.mobi/user/info?api_version=9.7.3&app_version=1.0.0&app_client_id=3&station_id={DD_token}&native_version=9.48.1&city_number=0101&latitude=31.275754&longitude=121.186023'
        info_headers = {
...
def do_sign(name,DD_token,DD_cookies):
    try:
        ...
        data = f'api_version=9.7.3&app_version=1.0.0&app_client_id=3&station_id={DD_token}&native_version=9.48.1&city_number=0101&latitude=31.275754&longitude=121.186023'
        do_sign_heards = {
        ...
        url = f'https://maicai.api.ddxq.mobi/point/home?api_version=9.7.3&app_version=1.0.0&app_client_id=3&station_id={DD_token}&native_version=9.48.1&city_number=0101&latitude=31.275754&longitude=121.186023&_={nowtime}'
        headers = {
            "user-agent": f"Mozilla/5.0 (iPhone; CPU iPhone OS 14_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 xzone/9.33.0 station_id/{DD_token}",
            "Accept-Encoding": "gzip, deflate, br",
            "Connection": "keep-alive",
        ...
        nowtime = int (round (time.time () * 1000))
        cheak_sign_url = f'https://maicai.api.ddxq.mobi/point/home?api_version=9.7.3&app_version=1.0.0&app_client_id=3&station_id={DD_token}&native_version=9.48.1&city_number=0101&latitude=31.275754&longitude=121.186023'
